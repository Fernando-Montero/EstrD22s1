    ...
    sacar c (Bolita co cel) = if esElMismoColor c co
                                            then cel
                                            else Bolita co (sacar c cel)
    ...
    ponerN n c cel = if n>=1 then poner c (ponerN (n-1) c cel)
                                       else cel
    ...
    ramaMasLarga EmptyT = []
    ramaMasLarga (NodeT e t1 t2) =  e : elMasLargo  (ramaMasLarga t1)   (ramaMasLarga t2)
...
--
  ...
  --  todosLosCaminos EmptyT = []
   ...
   -- func e (xs:xss) yss = 
    ...
    simplificar (Neg v) = simplificarNeg (simplificar v) 
    simplificar e = e
    ...
    arbol2 = NodeT 2 (NodeT 5 EmptyT EmptyT) (arbol)
